...
<body>
	...
	?>	
        <div class="container" style="margin-top: 80px;margin-bottom:80px;border: 1px solid #9C9C9C;background-color: #26A69A;border-radius: 8px;">     
        <div style="padding: 20px;">
        	...
        	<div>
        		<div class="form-group">
      <input type="submit" class="btn btn-md btn-submit" value="Submit">
  </div>
        	</div>
        	</form>	
        		</div>
